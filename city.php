...
<h2 class ="text-center"><?php echo $json['cities'][$i]['city']; ?></h2>
      <div class="container">
          <div class="row">
              <?php
                    for ($j=0; $j<3; $j++){
                    ...
                    echo'</div><br/><br/>
                    </div><div class="container"><div class="row places"> ';
                    for($j=0; $j<1; $j++){
                        echo 
                        '
                        <div class="col-md-6 order-sm-last col-sm-6">
        <img  class="col-12" src="'.$json['cities'][$i]['places'][$j]['images'][1].'" alt="image"  width="auto" > 
        Map      
     </div>
        <div class="col-12 col-sm-6 col-md-6 col-lg-6 text-justify">
            <h3>'.$json['cities'][$i]['places'][$j]['name'].'</h3>
            <h5>'.$json['cities'][$i]['places'][$j]['detail'].'</h5>
            <br/>
        </div>
        </div>
        <div class="row">
        <div class=" col-3">
        <img class=" col-12 imgplaces" src="'.$json['cities'][$i]['places'][$j]['images'][2].'" alt="image"  class="imgplaces"> 
        <img  class=" col-12 imgplaces" src="'.$json['cities'][$i]['places'][$j]['images'][1].'" alt="image" class="imgplaces">  
        <img  class=" col-12 imgplaces" src="'.$json['cities'][$i]['places'][$j]['images'][1].'" alt="image" class="imgplaces">  
        ...
        <img class=" col-12 imgplaces" src="'.$json['cities'][$i]['places'][$j]['images'][2].'" alt="image"  class="imgplaces"> 
        <img  class=" col-12 imgplaces" src="'.$json['cities'][$i]['places'][$j]['images'][1].'" alt="image" class="imgplaces">  
        <img  class=" col-12 imgplaces" src="'.$json['cities'][$i]['places'][$j]['images'][1].'" alt="image" class="imgplaces">          </div>
